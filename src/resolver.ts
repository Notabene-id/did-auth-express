import { Resolver, DIDCache } from "did-resolver";
  ...
  constructor(options: Options) {
    ...
    if (!options.networks && options.infuraProjectId) {
      networks = [
        ...
        {
          name: "rinkeby",
          rpcUrl: "https://rinkeby.infura.io/v3/" + options.infuraProjectId,
        },
        {
          name: "ropsten",
          rpcUrl: "https://ropsten.infura.io/v3/" + options.infuraProjectId,
        },
        {
          name: "kovan",
          rpcUrl: "https://kovan.infura.io/v3/" + options.infuraProjectId,
        },
        {
          name: "goerli",
          rpcUrl: "https://goerli.infura.io/v3/" + options.infuraProjectId,
        },
      ];
